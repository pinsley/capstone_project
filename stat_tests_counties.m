...
% normed_city_diffcounty_inc = (city_diffcounty_incomes2.*city_pops2);
% normed_city_stationary_inc = (city_stationary_incomes2.*city_pops2);
% normed_city_diffstate_inc = (city_diffstate_incomes2.*city_pops2);
% 
% mean(mean(normed_city_diffcounty_inc))
% test = reshape(normed_city_diffcounty_inc,[55,1]);
% this_std = std(test)
% std_error = this_std/sqrt(55)
% 
% mean(mean(normed_city_stationary_inc))
% test = reshape(normed_city_stationary_inc,[55,1]);
% this_std = std(test)
% std_error = this_std/sqrt(55)
% 
% mean(mean(normed_city_diffstate_inc))
% test = reshape(normed_city_diffstate_inc,[55,1]);
% this_std = std(test)
% std_error = this_std/sqrt(55)