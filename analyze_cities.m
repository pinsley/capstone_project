%city_pops;
% city_shouse_incomes;
% city_scounty_incomes;
% city_diffcounty_incomes;
% city_diffstate_incomes;
...
%     old_vec = new_vec;
% end
% new_vec =cat(1,city_pop_change(i,:),city_stationary_incomes2(i-1,:));
% if i>2
%     test_vec = cat(2,old_vec,new_vec);
% end
% end
